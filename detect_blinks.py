...
while True:
	...
	for rect in rects:
		...
		#for (x,y) in shape:
                ...
                cv2.circle(frame,(avg[0],avg[1]), 1, (0, 0, 255), -1)
                ...
                cv2.circle(frame,(calculatedCenter[0],calculatedCenter[1]), 1, (0, 0, 255), -1)
                cv2.circle(frame,(rightCenter[0],rightCenter[1]), 1, (0, 0, 255), -1)
                cv2.circle(frame,(leftCenter[0],leftCenter[1]), 1, (0, 0, 255), -1)
		#cv2.circle(frame,(tx/68,ty/68), 1, (0, 0, 255), -1)
                cv2.circle(frame,(shape[8][0],shape[8][1]), 1, (255, 0, 0), -1)
		...
		cv2.circle(frame,(pivot[0],pivot[1]), 1, (0, 255, 0), -1)
